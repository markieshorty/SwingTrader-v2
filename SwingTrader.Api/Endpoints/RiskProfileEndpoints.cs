    ...
    public static RouteGroupBuilder MapRiskProfileEndpoints(this RouteGroupBuilder api)
    {
            ...
            MarketRegime? regime) =>
        {
            ...
            return Results.Ok(new
            {
                ...
                profile.MaxConvictionForBuy,
                TargetMode = profile.TargetMode.ToString(),
                profile.TargetBandFloorPct,
                profile.TargetBandCeilingPct,
                profile.MaxHoldDays,
                ...
                AllowedRanges = new
                {
                    ...
                    MaxConvictionForBuy = new { Min = CapitalRules.MinMaxConvictionForBuy, Max = CapitalRules.MaxMaxConvictionForBuy },
                    TargetBandFloorPct = new { Min = CapitalRules.MinTargetPct, Max = CapitalRules.MaxTargetPct },
                    TargetBandCeilingPct = new { Min = CapitalRules.MinTargetPct, Max = CapitalRules.MaxTargetPct },
            ...
            IAccountContext ctx) =>
        {
            ...
            try
            {
                await riskProfileRepo.UpdateAsync(new AccountRiskProfile
                {
                    ...
                    MaxConvictionForBuy = req.MaxConvictionForBuy ?? CapitalRules.DefaultMaxConvictionForBuy,
                    TargetMode = Enum.TryParse<TargetMode>(req.TargetMode, ignoreCase: true, out var targetMode)
                        ? targetMode
                        : TargetMode.Flat,
                    TargetBandFloorPct = req.TargetBandFloorPct ?? CapitalRules.DefaultTargetBandFloorPct,
